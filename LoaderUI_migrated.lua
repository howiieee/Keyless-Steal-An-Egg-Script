...
-- =========================================================
-- Announcement banner
-- Simple full-width banner inspired by the supplied reference.
-- Only the item count and total sold value are displayed.
-- =========================================================
function LoaderUI:showAnnouncement(itemsSold, valueEarned)
    ...
    banner.BackgroundColor3 = Color3.fromRGB(112, 78, 42)
    banner.BackgroundTransparency = 0.08
    banner.BorderSizePixel = 0
    banner.Parent = screen

    local bannerStroke = Instance.new("UIStroke")
    bannerStroke.Color = Color3.fromRGB(30, 24, 18)
    ...
    main.Position = UDim2.fromOffset(20, 0)
    ...
    -- Slide in, hold, then slide out.
    banner.Position = UDim2.new(0.5, 0, 0.5, -35)
